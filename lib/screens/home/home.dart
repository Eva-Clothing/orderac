...
import 'package:orderac/main.dart';
...
class _HomeState extends State<Home> {
  ...
  bool currentTheme = (themeMode == ThemeMode.light)?false:true;

  // void _changeThemeIcon() {
  //   setState(() {
    ...
    final floatingActionButton = FloatingActionButton(
      ...
      onPressed: () {
        showDialog(
          ...
          child: AlertDialog(
            backgroundColor:
                (themeMode == ThemeMode.light) ? customCream : customDarkBlack,
            title: Text(
              'Your Order ID',
              style: TextStyle(
                  // color: Colors.white,
